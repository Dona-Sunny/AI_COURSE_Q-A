      ...
      <main className={styles.shell}>
        ...
        <section className={styles.responsePanel}>
          <div className={styles.responsePanelHeader}>
            <h2>Conversation</h2>
            <p>Each question is processed independently against the bundled notes.</p>
          </div>

          {error ? (
            <div aria-label="Conversation transcript" className={styles.transcript}>
              <article className={`${styles.message} ${styles.studentMessage}`}>
                <p className={styles.messageRole}>Student</p>
                <p className={styles.messageText}>{question}</p>
              </article>

              <article className={`${styles.message} ${styles.assistantMessage}`}>
                <div className={styles.responseCard}>
                  <p className={styles.messageRole}>Notes Assistant</p>
              ...
              <article className={`${styles.message} ${styles.assistantMessage}`}>
                <div className={styles.responseCard}>
                  ...
                  <p className={styles.answer}>
                    Searching the course notes for grounded support...
                  </p>
                </div>
              </article>
            </div>
          ...
          {result ? (
            <div aria-label="Conversation transcript" className={styles.transcript}>
              <article className={`${styles.message} ${styles.studentMessage}`}>
                <p className={styles.messageRole}>Student</p>
                <p className={styles.messageText}>{result.question ?? question}</p>
              </article>
